---
topic: "air"
title: Status of Ground-Level Ozone in B.C. (2019-2022)
output: 
...
*Suggested Citation*:  
Environmental Reporting BC. `r format(Sys.Date(), "%Y")`. Status of Ground-Level Ozone in B.C. (`r year_range`). State of Environment Reporting, Ministry of Environment and Climate Change Strategy, British Columbia, Canada.
