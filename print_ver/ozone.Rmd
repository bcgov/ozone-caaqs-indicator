...
-   Eighteen days were flagged as exceptional events as a result of suspected wildfire influence at two monitoring stations in B.C. for the `r min_year`-`r max_year` reporting period [Hope](http://www.env.gov.bc.ca/epd/bcairquality/readings/map/station.html#E223756) and [Mission](http://www.env.gov.bc.ca/epd/bcairquality/readings/map/station.html#E302130)). The daily concentrations for these days were removed from the calculations of management levels, resulting in a change from red to orange for the Lower Fraser Valley management level for ground-level ozone.
