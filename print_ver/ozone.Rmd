...
## Reading in results data objects
...
Published and Available On-Line at Environmental Reporting BC (December 2018):
<http://www.env.gov.bc.ca/soe/indicators/air/ozone.html>

Email correspondence to: envreportbc@gov.bc.ca

*Suggested Citation*:  
Environmental Reporting BC. 2018. Status of Ground-Level Ozone in B.C. (`r min_year`-`r max_year`). State of Environment Reporting, Ministry of Environment and Climate Change Strategy, British Columbia, Canada.


\newpage

# Appendix: Detailed ground-level ozone Canadian Ambient Air Quality Standard results for each monitoring station within air zones in B.C. (`r min_year`-`r max_year`)


```{r appendix, results='asis', fig.height=3.5}

## TESTING
foo <- stn_plots[1:2] #object for testing iwalk()
##

iwalk(foo,  ~ {
  
  stn <- ozone_caaqs_results %>% 
    filter(ems_id == names(foo[1])) 
