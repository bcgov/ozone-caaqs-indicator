---
topic: "air"
title: Status of Ground-Level Ozone in B.C. (2015-2017)
...
-   **Ozone levels met the Canadian Ambient Air Quality Standard at `r num_stns_achieved` of `r num_stns` B.C. 
    ...
    Ozone levels were $\leq\!\!$ 50 ppb at `r num_values_50` reporting stations (`r perc_values_50`%). `r to_titlecase(as.character(english(num_values_60)))`
    station reported ozone levels \>60 ppb.
...
-   Eight days were flagged as exceptional events as a result of suspected wildfire influence at two monitoring stations in B.C. for the `r min_year`-`r max_year` reporting period ([Agassiz](http://www.env.gov.bc.ca/epd/bcairquality/readings/map/station.html#E293810) and [Hope](http://www.env.gov.bc.ca/epd/bcairquality/readings/map/station.html#E223756)). The daily concentrations for these days were removed from the calculations of management levels, resulting in a change from red to orange for the Lower Fraser Valley management level for ground-level ozone.
...
Published and Available On-Line at Environmental Reporting BC (January 2019):
