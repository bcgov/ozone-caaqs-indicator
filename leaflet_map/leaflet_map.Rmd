...
stations$caaqs_category_html <- rcaaqs:::cut_management(stations$ambient_metric_value, "o3", output = "breaks_h")
...
stations <- stations %>%
  ...
  mutate(ambient_caaqs = replace(ambient_caaqs, is.na(ambient_caaqs), "Insufficient Data"),
  ...
  filter(ambient_caaqs != "Insufficient Data") %>%
...
az <- mutate(az, 
             ...
             p_station_id = ambient_rep_stn_id) %>%
